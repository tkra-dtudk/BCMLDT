...
import network.*;
import refCostFun.*;
public class LocalDetourMainScript {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int j=1;j<=1;j++) {
			...
			//rum.theta=0.2;
			//rum.theta=0.000001; //experiment with equal flow
			rum.theta=0.1;
			...
			for (int k=1;k<=1;k++) {
				...
				double localMaximumCostRatio = 1.2;
				for (int q=1;q<=1;q++)
				{
...
//					double localMaximumCostRatioCutOff = 2.0; // cutoff should be geq localMaximumCostRatio
					double localMaximumCostRatioCutOff = localMaximumCostRatio+.5;
